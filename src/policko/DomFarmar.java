 ...
 */
public class DomFarmar extends Policko implements IObyvatelny {
    private int pocetObyvatelov;

    public DomFarmar(int pocetObyvatelov, int riadok, int stlpec) {
        super(riadok, stlpec);
