 ...
 */
public class DomRybar extends Policko implements IObyvatelny {
    private int pocetObyvatelov;

    public DomRybar(int pocetObyvatelov, int riadok, int stlpec) {
        super(riadok, stlpec);
