 ...
 * 
 * triedu Platno som celú zobral z projektu RPSLS na moodli, upravoval som iba titulok plátna a jeho veľkosť
 */
public class Platno {
    ...
    public static Platno dajPlatno() {
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("Semestralka", 600, 600, Color.white);
        }
    ...
    private interface IDraw {
        void draw(Graphics2D graphic); //public
    }
    ...
    private class PopisTvaru implements IDraw {
        ...
        PopisTvaru(Shape tvar, String farba) { //public
            this.tvar = tvar;
            this.farba = farba;
        }
    ...
    private class PopisObrazku implements IDraw {
        ...
        PopisObrazku(BufferedImage obrazok, AffineTransform transformacia) { //public
